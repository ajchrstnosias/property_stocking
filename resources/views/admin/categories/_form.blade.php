...
<div class="mt-8 flex justify-end">
    <a href="{{ route('admin.categories.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-lg mr-4 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
        Cancel
    </a>
